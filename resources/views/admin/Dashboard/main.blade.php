...
@section('content')
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ps ps--active-y">
                    ...
                    <div class="card z-index-2 ">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                <div class="chart">
                                    <canvas id="chart-bars" class="chart-canvas" height="340" width="677"
                                        style="display: block; box-sizing: border-box; height: 170px; width: 338.8px;"></canvas>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card z-index-2  ">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                            <div class="bg-gradient-success shadow-success border-radius-lg py-3 pe-1">
                                <div class="chart">
                                    <canvas id="chart-line" class="chart-canvas" height="340" width="677"
                                        style="display: block; box-sizing: border-box; height: 170px; width: 338.8px;"></canvas>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card z-index-2 ">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                            <div class="bg-gradient-dark shadow-dark border-radius-lg py-3 pe-1">
                                <div class="chart">
                                    <canvas id="chart-line-tasks" class="chart-canvas" height="340" width="1475"
                                        style="display: block; box-sizing: border-box; height: 170px; width: 737.6px;"></canvas>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-group mt-2">
                                                    ...
                                                    <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                        data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                        aria-label="Jessica Doe" data-bs-original-title="Jessica Doe">
        ...
        <div class="ps__rail-x" style="left: 0px; bottom: -468px;">
            <div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div>
        </div>
        <div class="ps__rail-y" style="top: 468px; height: 1411px; right: 0px;">
            <div class="ps__thumb-y" tabindex="0" style="top: 352px; height: 1059px;"></div>
        </div>
    </main>
@endsection
