...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('Frontend/css/swalert.css') }}">
...
<script src="{{ asset('Frontend/js/swalert.js') }}"></script>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.add-to-cart').click(function() {
            ...
            var thumb = $('.cart_product_thumb_' + id).val();
            var discount = $('.cart_product_discount_' + id).val();
