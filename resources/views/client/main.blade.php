    ...
    <section class="slider-section">
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                @foreach ($sliderActive as $item)
                    <div class="carousel-item active" style="background-image: url({{ url($item->thumb) }});">
                        <div class="carousel-caption d-none d-md-block">
                            <h3>{{ $item->name }}</h3>
                            <p>NEW SEASON for Women</p>
                        </div>
                    </div>
                @endforeach
                @foreach ($sliders as $slider)
                    <div class="carousel-item" style="background-image: url({{ url($slider->thumb) }});">
                        <div class="carousel-caption d-none d-md-block">
                            <h3>{{ $slider->name }}</h3>
                            <p>Shop Now</p>
                        </div>
                    ...
                    @foreach ($categorysLimit as $category)
                        <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                            ...
                            <div class="block1 wrap-pic-w">
                                <img height="300px" src="{{ url($category->avt_menu) }}" alt="IMG-BANNER">
